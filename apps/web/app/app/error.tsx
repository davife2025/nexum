    ...
    <div style={{ background: "#0F172A", minHeight: "100vh", fontFamily: "'Plus Jakarta Sans',system-ui,sans-serif" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "48px 24px", textAlign: "center" }}>
        <div style={{ background: "#0A2540", border: "1px solid rgba(255,77,106,0.3)", borderRadius: 12, padding: "48px 32px" }}>
          ...
          <div style={{ fontSize: 12, fontFamily: "'IBM Plex Mono',monospace", color: "#4A7090", background: "#0F172A", border: "1px solid #1E3A5F", borderRadius: 8, padding: "10px 16px", marginBottom: 24, textAlign: "left", wordBreak: "break-all" as const }}>
            {error.message}
          </div>
          <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
            ...
            <Link href="/app" style={{ fontSize: 13, color: "#4A7090", border: "1px solid #1E3A5F", padding: "10px 20px", borderRadius: 8, textDecoration: "none" }}>
              ← Dashboard
            </Link>
          </div>
        </div>
