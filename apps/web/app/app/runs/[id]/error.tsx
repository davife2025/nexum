    ...
    <div style={{ background: "#0F172A", minHeight: "100vh", fontFamily: "'Plus Jakarta Sans',system-ui,sans-serif" }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "48px 24px", textAlign: "center" }}>
        <div style={{ background: "#0A2540", border: "1px solid rgba(255,77,106,0.3)", borderRadius: 12, padding: "48px 32px" }}>
          ...
          <div style={{ fontFamily: "'Space Grotesk',sans-serif", fontWeight: 700, fontSize: 20, color: "#F8FAFC", marginBottom: 10 }}>Run not found</div>
          ...
          <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
            <button onClick={reset} style={{ fontSize: 13, fontWeight: 600, color: "#0F172A", background: "#00E5C9", border: "none", padding: "10px 24px", borderRadius: 8, cursor: "pointer" }}>Retry</button>
            <Link href="/app/runs" style={{ fontSize: 13, color: "#4A7090", border: "1px solid #1E3A5F", padding: "10px 20px", borderRadius: 8, textDecoration: "none" }}>← All Runs</Link>
          </div>
        </div>
      </div>
    </div>
